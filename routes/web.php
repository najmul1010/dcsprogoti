...
Route::get('HitIP', 'NewApiController@HitIP');
...
Route::get('visa_check', 'LiveApiProgotiController@Visa_Check');
...
Route::post('activePo', 'POListController@POLIST_ActiveInactive');
...
Route::group(['middleware' => ['Logcheck']], function () {
    ...
    Route::group(['middleware' => ['Project']], function () {
        ...
        Route::prefix('operation')->group(function () {
            ...
            //Route::get('/statusSession', 'DashboardController@statusSession');
            //survey 
            Route::get('survey', 'SurveyController@Survey')->name('survey-request');
            Route::get('/SurveyTable', 'SurveyController@SurveyTable');
        });
