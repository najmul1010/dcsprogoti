              ...
              <div class="card_section">
                <div class="row">
                  ...
                  <div class="col-md-2.5">
                    <div class="card" style="width: 18rem; height: 131;">
                      <div class="card-body" style="background-color:#90ee90;">
                        <h5 class="card-title">@lang('dashboard.card5')</h5>
                        <h5 class="text-center" id="totalAdmission">{{ $profilepending_admission->count }}</h5>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-2.5">
...
<script>
  $(document).ready(function() {
    ...
    //alert($('#branch').val());
      ...
      fill_datatable(division, region, area, branch, dateFrom, dateTo, po, roll, checkerp, local);
    ...
    $('#rejected').click(function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          $('#totalAdmission').text(data[10]);
          $('#total_disbuse').text(data[11]);
          $('#startDateShow').text(data[12]);
          $('#endDateShow').text(data[13]);
          console.log(data);
        }
      });
      // search for pending status
