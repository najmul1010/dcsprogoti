                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                if (session('recommend')) {
                                    ...
                                    Alert::alert('সুপারিশ- ', session('recommend'), 'Type');
                                }
                                else if(session('sendback')){
                                    Alert::alert('সেন্ডব্যাক-', session('sendback'), 'Type');
                                }
                                else if(session('approve')){
                                    Alert::alert('অনুমোদন-',session('approve'),'Type');
                                }
                                ?>
                                ...
                                Session::forget('recommend');
                                Session::forget('sendback');
                                Session::forget('approve');
                                ?>
                                <div class="form_value">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            <label class="ml-2" for="po">@lang('loan.co')</label>
                                    ...
                                    <div class="form-row">
                                        ...
                                        $frmday = $year . '-' . $month . '-01';
                                        @endphp
                                        <div class="col-md-2 mb-3">
                                            <label for="dateFrom" class="form-label">@lang('loan.dateRange')</label>
                                            <input type="date" value="<?php echo $frmday; ?>" class="form-control" id="dateFrom" name="dateFrom">
                                        </div>
                                ...
                                <table style="text-align: center;" class="table table-bordered" id="myTable">
                                    <thead>
                                        <tr class="brac-color">
                                            ...
                                            <th>@lang('admission.table_header8')</th>
