                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <img src="{{ asset('images/Sample_User_Icon.png') }}" class="img-thumbnail" alt="Applicant image">
                                                @else
                                                <img src="{{ $data->ApplicantSinglePic }}" class="img-thumbnail" alt="Applicant --image" height="160" width="160">
                                                @endif
                                            </div>
                                            <div class="col-md-8">
                                                <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card card-custom header-section">
                                    <div class="card-body">
                                        ...
                                        <p>@lang('loanApproval.header21') : {{$coname}}</p>
                                        <p>@lang('loanApproval.header20') : {{$data->assignedpo}}</p>
