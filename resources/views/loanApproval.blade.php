              ...
              <div class="col-md-4">
                <div class="card card-custom header-section">
                  <div class="card-body">
                    ...
                    if (session('project') == 'Progoti') {
                    ?>
                      <p>@lang('loanApproval.header20') : {{$poName->coname}}</p>
              ...
              <div class="tab-content pre-scrollable" style="overflow-x: hidden;">
                ...
                <div class="tab-pane" id="acceptiblity">
                  ...
                  if (session('projectcode') == '60') {
                    if ($productcode == '79') {
                  ?>
                      @include('checklist_remittance');
                      @include('checklist_common');
                    <?php
                    } else if ($productcode == '100') {
                    ?>
                      @include('checklist_nirvorota');
                      @include('checklist_common');
                    <?php
                    } else if ($productcode == '80') {
                    ?>
